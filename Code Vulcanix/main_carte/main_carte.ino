...
unsigned long T_homing;
unsigned long T_neutre;
int valAnalog[7];
...
{ 
  ...
  //NEUTRE
  if(statePaletteDecrease)
  {
   if  ((wantedPosition=!homingPosition) and ((millis()-T_neutre>2000)))
   {
  ...
  //HOMING
  if(statePaletteIncrease and statePaletteDecrease)
  {
   
   if  ((wantedPosition=!homingPosition) and ((millis()-T_homing>2000)))
   {
